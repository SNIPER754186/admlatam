...
[[ -e /etc/SCRIPT-LATAM/temp/RegTimeT ]] || {
  check_keyoficial() {
    ...
    IP2="$IP"
    permited=$(curl -sSL "https://raw.githubusercontent.com/SNIPER754186/admlatam/refs/heads/main/Instalador/Control-IP")
...
msg -bar
msg -tit
title=$(echo -e "\033[1;4;92m$(cat ${SCPdir}/message.txt| head -1)\033[0;37m")

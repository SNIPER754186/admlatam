...
#msg -bar3
msg -bar3
echo -e " apt update -y && apt upgrade -y \n wget --no-check-certificate -q https://raw.githubusercontent.com/SNIPER754186/admlatam/refs/heads/main/init/setup.gen && chmod 777 insta-bot.sh && ./insta-bot.sh"
msg -bar3
...
dropIP() {
#[[ ! -e /etc/dropIP.sh ]] && wget -q -O /etc/dropIP.sh https://www..com/s//dropIP.sh?dl=0
unset PIDGEN
